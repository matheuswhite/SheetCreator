...
public class EighthNote extends Notes {

	public EighthNote(IComponent component, int position_x, int position_y,
			List<Flag> flag) {
	...
	public String getPathImage() {
		String exit = "resource/eighthnote500.svg.png";
		if(this.flags.get(Notes.TONE_POSITION).equals(Flag.C)) {
			exit = "resource/eighthnote500_do.svg.png";
		}
		
		if(this.flags.get(Notes.ACCIDENTAL_SYMBOL).equals(Flag.SHARP)){
			exit = "resource/eighthnote500_sharp.png";
			if(this.flags.get(Notes.TONE_POSITION).equals(Flag.C)) {
				exit = "resource/eighthnote500_do_sharp.png";
			}
		}
		else if(this.flags.get(Notes.ACCIDENTAL_SYMBOL).equals(Flag.FLAT)) {
			exit = "resource/eighthnote500_flat.png";
			if(this.flags.get(Notes.TONE_POSITION).equals(Flag.C)) {
				exit = "resource/eighthnote500_do_flat.png";
			}
		}
		return exit;
	}
