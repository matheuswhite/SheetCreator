...
public class MusicalStaff extends IComponent{
	...
	public MusicalStaff(int[] positionDoc, Flag ordemFlag /*1º,2º,3º ou 4º staff */) {
	...
	protected void draw() {
		...
		this.label.setBounds(this.position[0] + ordem.get(ordemFlag),
				this.position[1] + MusicalStaff.STAFF_POSITION_X,
